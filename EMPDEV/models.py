...
class Device(models.Model):
    ...
    RamDevice = models.ForeignKey(RamDevice, on_delete=models.CASCADE, null=True)
    Employe = models.ForeignKey(Employe, on_delete=models.CASCADE, default=1)
    StorgeDevice = models.ForeignKey(StorgeDevice, on_delete=models.CASCADE, null=True)
