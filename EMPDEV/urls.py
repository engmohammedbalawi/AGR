...
urlpatterns = [
    ...
    path('index/details/<int:id>/<str:name>/maintaince/', view=maintiance, name='maintaince1'),
    path('index/details/<int:id>/<str:name>/maintaince/tablemain/', view=tablemain, name='tablemain1'),
    ...
    path('printer/',view=printer,name='printer'),
     path('printer/tableprinter/',view=tableprinter,name='tableprinter'),
     path('printer/deletedevice/<int:id>/',view=deletedevice,name='deleteprinter'),
